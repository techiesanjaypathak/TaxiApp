...
class LoginController: UIViewController {
    ...
    private let dontHaveAccountButton: UIButton = {
        let button = UIButton()
            .customAttributedNavigationButton(withTitle: "Don't have an account? ",
                                              message: "Sign Up", self, action: #selector(showSignup))
        return button
    }()
    ...
    func configureUI() {
        ...
        entryStack.anchor(top: titleLabel.bottomAnchor,
